...
export default function BuilderPage() {
  ...
  const checkValidation = () => {
    ...
    if (step === 2) {
      if (
        ...
        return {
          isValid: false,
          message: 'At least one Education degree is required.'
        };
      }
    }
    ...
    if (step === 3) {
      if (
        ...
        return {
          isValid: false,
          message: 'Please add at least one Soft Skill and Language.'
        };
      }
    }
    ...
    try {
      ...
      // ---------------------------------------------------------------
        ...
        // -------------------------------------------------------------
          ...
          const images = await convertPdfAllPagesToImages(file);
      ...
      // Directly load structured JSON
      loadFullData(parsedData.data);

      // Go to Profile step after successful extraction
      setStep(1);

    } catch (error: any) {
      console.error('Upload Error:', error);

      // Keep your existing user-facing error behavior.
      // Importantly, we do NOT automatically jump to manual step.
      alert(
  ...
  const deleteBtn = (onClick: () => void) => (
    <button
      onClick={onClick}
      className="absolute top-3 right-3 sm:top-4 sm:right-4 flex items-center gap-1 rounded-lg border border-red-500/20 bg-red-500/10 px-2 py-1 text-[11px] font-medium text-red-400 transition-all hover:bg-red-500 hover:text-white hover:border-red-500"
    >
  ...
  const cardCls =
    'relative rounded-2xl border border-violet-500/15 bg-white/[0.04] p-5 sm:p-6 mb-4 shadow-lg shadow-black/20';
  ...
  const emptyState = (
    ...
    <div className="flex flex-col items-center justify-center gap-5 rounded-2xl border-2 border-dashed border-violet-500/20 bg-white/[0.02] py-16 sm:py-20 text-center">
      ...
      <p className="text-base font-medium text-violet-300/60">
        {message}
      </p>

      <Button
        onClick={onAdd}
        className="bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-semibold px-8 py-5 rounded-xl hover:from-violet-500 hover:to-indigo-500 hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-violet-900/30"
      >
        <Plus className="mr-2 h-4 w-4" />
        {btnLabel}
      </Button>
  ...
  return (
    <div
      className="relative flex min-h-screen w-full flex-col items-center px-4 py-6 sm:px-6 sm:py-10 overflow-hidden"
      style={{
        background:
          'radial-gradient(ellipse at 20% 0%, #1a0733 0%, #080812 55%, #000000 100%)'
      }}
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute -top-48 -left-48 h-[600px] w-[600px] rounded-full bg-violet-700/20 blur-[140px]"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-0 -right-48 h-[500px] w-[500px] rounded-full bg-indigo-700/15 blur-[130px]"
        />
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[300px] w-[300px] rounded-full bg-violet-900/10 blur-[100px]"
        />
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 mb-7 text-center shrink-0"
      >
        ...
        <p className="text-[11px] sm:text-xs font-semibold tracking-[0.25em] uppercase text-violet-300/60">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 mb-8 w-full max-w-5xl rounded-[2rem] sm:rounded-[2.5rem] border border-violet-500/15 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-6 sm:p-8 md:p-12 shadow-2xl shadow-violet-950/60 backdrop-blur-2xl"
      >
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 0 && (
            <motion.div
              ...
              animate="animate"
              exit="exit"
              className="space-y-8 py-6 sm:py-10 text-center"
            >
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-violet-500/30 bg-violet-500/10 px-4 py-1.5 text-xs font-semibold text-violet-200">
                ...
                AI-Powered · ATS-Optimised · Free
              </div>

              <div className="space-y-3">

                <h2 className="text-[clamp(2rem,6vw,3.5rem)] font-black tracking-tight text-white leading-[1.1]">
                  Your resume,
                  <br />
                  <span className="bg-gradient-to-r from-violet-300 via-indigo-300 to-violet-400 bg-clip-text text-transparent">
                    reinvented by AI
                  </span>
                </h2>

                <p className="mx-auto max-w-lg text-base sm:text-lg text-violet-200/70 leading-relaxed font-medium">
                  Upload a PDF for instant AI extraction, or craft a polished,
                  ATS-ready document from scratch in minutes.
                </p>
              ...
              <div className="mx-auto grid max-w-2xl grid-cols-1 gap-5 pt-4 sm:grid-cols-2">
                ...
                >
                  ...
                  <div
                    className={`flex h-13 w-13 items-center justify-center rounded-xl border border-violet-500/30 bg-violet-500/15 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 ${
                  ...
                  <div className="text-center">
                    ...
                    <p className="mt-0.5 text-xs text-violet-300/55 font-normal">
                      Click or drag & drop PDF/Image
                    </p>
                ...
                <button
                  onClick={() => setStep(1)}
                  className="group flex h-40 sm:h-44 flex-col items-center justify-center gap-4 rounded-2xl bg-gradient-to-br from-violet-600 to-indigo-700 font-medium text-white transition-all duration-300 hover:from-violet-500 hover:to-indigo-600 hover:scale-[1.02] hover:shadow-xl hover:shadow-violet-900/40 active:scale-[0.98]"
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="mt-0.5 text-xs text-violet-200/65 font-normal">
                      Build step-by-step with precision
                    </p>
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
                ...
                {[
                  ...
                  <span
                    key={f}
                    className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-xs font-medium text-violet-300/60"
                  >
                    {f}
                  </span>
                ))}
          ...
          {step > 0 && step < 8 && (
            ...
            >
              ...
              <div className="mb-7 sm:mb-10 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-1 rounded-full bg-violet-500/20 px-2 py-0.5 text-[10px] font-bold text-violet-300">
                      {step} / 7
                    </span>
                  ...
                  {STEP_META.map((_, i) => {
                    ...
                    return (
                      <button
                        ...
                        title={STEP_META[i].label}
                        className={`h-1.5 flex-1 rounded-full transition-all duration-500 ${
                          step > idx
                            ? 'bg-violet-400/80 cursor-pointer hover:bg-violet-300'
                            : step === idx
                              ? 'bg-gradient-to-r from-violet-400 to-indigo-400 shadow-[0_0_10px_rgba(139,92,246,0.7)]'
                              : 'bg-white/10'
                        }`}
                      />
                    );
              ...
              <div
                className="max-h-[58vh] min-h-[46vh] overflow-y-auto overflow-x-hidden pr-1 sm:pr-3"
                style={{
                  scrollbarWidth: 'thin',
                  scrollbarColor:
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="rounded-xl border border-amber-500/20 bg-amber-500/[0.06] p-4 sm:p-5">
                      ...
                      <SmartTagInput
                        ...
                        placeholder="Full Stack Developer, Professor"
                        onChange={(tags) =>
                          updateData('personalInfo', {
                            website: tags.join(',')
                          })
                      ...
                      <p className="mt-2.5 text-[11px] font-medium text-amber-300/50">
                        ✦ Used to tailor ATS keywords to your target roles.
                        Be specific.
                      </p>
                ...
                {step === 3 && (
                  <div className="space-y-6">
                    ...
                    <div className="border-b border-violet-500/15 pb-4">
                      ...
                      <p className="mt-1 text-sm font-medium text-violet-300/70">
                    ...
                    {[
                      {
                        ...
                        placeholder: 'JavaScript, Excel'
                      },
                      {
                        key: 'tools',
                        label: 'Tools & Frameworks',
                        placeholder:
                          'Figma, Docker, VS Code, Excel, etc'
                      },
                      {
                        key: 'soft',
                        label: 'Soft Skills',
                        placeholder:
                          'Leadership, Agile, Communication, etc.'
                      },
                      {
                        key: 'languages',
                        label: 'Languages',
                      ...
                      ({
                        ...
                        <div key={key} className="space-y-2">
                          ...
                          <label className="ml-1 text-xs font-bold uppercase tracking-widest text-violet-200">
                            {label}{' '}

                            {['soft', 'languages'].includes(
                              key
                            ) && (
                  ...
                  <div className="space-y-5">
                    ...
                    {data.experience.length === 0 ? (
                      ...
                      <>
                        {sectionHeader(
                          'Experience',
                          'Your work history and internships.',
                          () =>
                            addArrayItem('experience', {
                              title: '',
                              company: '',
                ...
                {step === 6 && (
                  <div className="space-y-6">
                    ...
                    <div className="border-b border-violet-500/15 pb-4">
                      ...
                      <p className="mt-1 text-sm font-medium text-violet-300/70">
                        Stand out with certs, awards &amp; interests.
                      </p>
                    ...
                    {renderInput({
                      ...
                      placeholder:
                        'AWS Solutions Architect, Google Analytics, NPTEL…',
                      isTextarea: true
                    })}
                    ...
                    {renderInput({
                      ...
                      placeholder:
                        '3D Design, Open Source, Photography…'
                    })}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between border-b border-violet-500/15 pb-5">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-violet-300/70">
                          Your elevator pitch. Let AI craft it from your data.
                        </p>
                      ...
                      <Button
                        ...
                        className="w-full sm:w-auto shrink-0 gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold shadow-lg shadow-amber-900/30 hover:from-amber-400 hover:to-orange-400 hover:scale-[1.02] active:scale-95 transition-all rounded-xl px-5"
                      >
                    ...
                    {data.personalInfo.summary && (
                      <div className="rounded-xl border border-violet-500/20 bg-violet-500/[0.05] p-4">
                        ...
                        <p className="mb-2 text-[10px] font-bold uppercase tracking-widest text-violet-400/60">
                          Live Preview
                        </p>
              ...
              <div className="mt-7 border-t border-violet-500/15 pt-5">
                ...
                {!validationState.isValid && (
                  <motion.div
                    ...
                    className="mb-4 flex items-center gap-2 rounded-lg bg-red-500/10 px-3 py-2 text-sm text-red-400 border border-red-500/20"
                  >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold text-violet-300 hover:bg-white/8 hover:text-white transition-all"
                  >
            ...
            >
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-violet-500/15 pb-5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-medium text-violet-300/70">
                    Download now, or let AI polish everything.
                  </p>
                  ...
                  >
                    ...
                    {isFullOptimizing ? (
                      ...
                      <span className="animate-in fade-in zoom-in duration-300 text-[11px] sm:text-sm text-center leading-tight">
                        <span className="hidden sm:inline">
                          Optimised successfully ready to download!
                        </span>
                      ...
                      <>
                        <span className="hidden sm:inline">
                          Auto-Optimise for ATS
                        </span>

                        <span className="sm:hidden">
                          Automatically ATS Optimise
                        </span>
                      </>
                    )}
      ...
      <motion.footer
        ...
        className="relative z-10 w-full mt-auto shrink-0 border-t border-violet-500/10 pt-6 pb-5 text-center"
      >

        <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-xs font-medium text-violet-400/60 mb-4">

          <span className="font-black text-violet-400/80 tracking-widest uppercase text-[11px]">
            AICV-Pro
          </span>

          <span className="text-violet-500/30">
            ·
          </span>
          ...
          {[
            ...
            <React.Fragment key={href}>
              ...
              <span className="hidden sm:inline text-violet-500/30">
                ·
              </span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6">
          ...
          <a
            ...
            className="flex items-center gap-2 text-[11px] font-medium text-violet-400/45 hover:text-violet-300 transition-colors group"
          >
          ...
          <span className="hidden sm:inline text-violet-600/40">
            ·
          </span>
